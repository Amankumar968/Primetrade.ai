      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
            A powerful and intuitive task management system to help you organize your work,
          ...
          <div className="mt-10 flex justify-center gap-4">
            ...
            <Link
              href="/login"
              className="px-8 py-3 bg-white text-blue-600 rounded-lg hover:bg-gray-50 transition-colors text-lg font-medium shadow-lg border-2 border-blue-600"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">
              Filter and search tasks by status, priority, and keywords. Find what you need instantly.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">
              Track your progress with real-time statistics and insights about your task completion.
            </p>
          </div>
        </div>
      </div>
